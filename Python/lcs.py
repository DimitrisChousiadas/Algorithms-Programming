...
# A recursive implementation of finding the longest common subsequence
...
# the longest common subsequence of the substrings s1[:i] and s2[:j] is:
...
# The cell (i,j) of the array will the length of the longest common subsequence
...
str2 = list(input())
print("The lenght of the longest common subsequence is:")
